(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~challenge-challenge-module~cities-cities-module~discover-discover-module"], {
  ...
  function node_modulesNgxOwlCarouselOFesm2015NgxOwlCarouselOJs(module, __webpack_exports__, __webpack_require__) {
    ...
    class CarouselService {
        ...
        // },
        {
          ...
          run: () => {
            ...
            append = append.map(slide => {
              slide.id = "".concat(this.clonedIdPrefix).concat(slide.id);
      ...
      _validateOptions(options, configOptions) {
        ...
        const setRightOption = (type, key) => {
          this.logger.log("options.".concat(key, " must be type of ").concat(type, "; ").concat(key, "=").concat(options[key], " skipped to defaults: ").concat(key, "=").concat(configOptions[key]));
    ...
    class NavigationService {
      ...
      spyDataStreams() {
        ...
        const changedSettings$ = this.carouselService.getChangedState().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(data => data.property.name === 'position'), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(data => {
          this.update(); // should be the call of the function written at the end of comment
      ...
      _updateNavPages() {
        ...
        let size = settings.center || settings.autoWidth || settings.dotsData ? 1 : settings.dotsEach || settings.items;
        size = +size;
    ...
    class HashService {
      ...
      listenToRoute() {
        ...
        this.route.fragment.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["skip"])(count)).subscribe(fragment => {
    ...
    class CarouselComponent {
      ...
      spyDataStreams() {
        ...
        this._initializedCarousel$ = this.carouselService.getInitializedState().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(() => {
          ...
          this.initialized.emit(this.slidesOutputData); // this.slidesOutputData = {};
        }));
        this._translatedCarousel$ = this.carouselService.getTranslatedState().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(() => {
          this.gatherTranslatedData();
          this.translated.emit(this.slidesOutputData); // this.slidesOutputData = {};
        }));
        this._changeCarousel$ = this.carouselService.getChangeState().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(() => {
          this.gatherTranslatedData();
          this.change.emit(this.slidesOutputData); // this.slidesOutputData = {};
        }));
        this._changedCarousel$ = this.carouselService.getChangeState().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(value => {
          ...
          this.gatherTranslatedData();
          this.changed.emit(slidesData.slides.length ? slidesData : this.slidesOutputData); // console.log(this.slidesOutputData);
      ...
      _winResizeWatcher() {
        if (Object.keys(this.carouselService._options.responsive).length) {
          this.resizeSubscription = this.resizeService.onResize$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(() => this.carouselWindowWidth !== this.el.nativeElement.querySelector('.owl-carousel').clientWidth), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["delay"])(this.carouselService.settings.responsiveRefreshRate)).subscribe(() => {
    ...
    class StageComponent {
      ...
      ngOnInit() {
        this._oneMoveSubsription = this._oneDragMove$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["first"])()).subscribe(() => {
          this._sendChanges();
        });
      }
    ...
    CarouselModule.decorators = [{
      ...
      args: [{
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"] // BrowserAnimationsModule, // there's an issue with this import while using lazy loading of module consuming this library. I don't remove it because it could be needed during future enhancement of this lib.
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppDiscoverCreateChallengeBtnModalCreateChallengeBtnModalComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppDiscoverDiscoverChallengeProviderDiscoverChallengeProviderComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppDiscoverDiscoverOfferingsDiscoverOfferingsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppDiscoverDiscoverProvidersDiscoverProvidersComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppDiscoverSelectSectorSelectSectorComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppDiscoverWidgetsSectorFilterSectorFilterComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDiscoverCreateChallengeBtnModalCreateChallengeBtnModalComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDiscoverCreateChallengeBtnModalCreateChallengeBtnModalComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CreateChallengeBtnModalComponent", function () {
      return CreateChallengeBtnModalComponent;
    });
    /* harmony import */
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_ngxs_store__WEBPACK_IMPORTED_MODULE_3__["Select"])(_state_loggedinuser_state__WEBPACK_IMPORTED_MODULE_4__["LoggedInUserState"])], CreateChallengeBtnModalComponent.prototype, "loggedInUser$", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])("closebutton", {
      static: false
    })], CreateChallengeBtnModalComponent.prototype, "closebutton", void 0);
    CreateChallengeBtnModalComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: "app-create-challenge-btn-modal",
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./create-challenge-btn-modal.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/discover/create-challenge-btn-modal/create-challenge-btn-modal.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./create-challenge-btn-modal.component.css */
      "./src/app/discover/create-challenge-btn-modal/create-challenge-btn-modal.component.css")).default]
  ...
  /***/
  function srcAppDiscoverDiscoverChallengeProviderDiscoverChallengeProviderComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDiscoverDiscoverChallengeProviderDiscoverChallengeProviderComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DiscoverChallengeProviderComponent", function () {
      return DiscoverChallengeProviderComponent;
    });
    /* harmony import */
    ...
    var _const__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../../const */
    "./src/app/const.ts");
    /* harmony import */


    var _discover_challenges_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./discover-challenges.service */
    ...
    let DiscoverChallengeProviderComponent = class DiscoverChallengeProviderComponent {
      ...
      getChallenges() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          try {
            ...
            this.challenges = yield this._dc.getChallenges(this.post_data); // console.log(this.challenges)
      ...
      solutionFilter(event) {
        ...
        if (event.target.checked) {
          this.solutionFilterClauses.push({
            from: parseInt(from),
            to: parseInt(to)
          });
        } else {
        ...
        if (lodash__WEBPACK_IMPORTED_MODULE_6__["isEmpty"](this.solutionFilterClauses)) delete this.post_data.filter.by_solution;
        this.getChallenges();
      }
      ...
      anchorFilter(event) {
        ...
        if (lodash__WEBPACK_IMPORTED_MODULE_6__["isEmpty"](this.anchorFilterClauses)) delete this.post_data.filter.by_anchor;
        this.getChallenges();
      }
      ...
      filterSmartCity(event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          ...
          try {
            ...
            if (lodash__WEBPACK_IMPORTED_MODULE_6__["isEmpty"](this.anchorIdBasedOnSmartCity)) this.anchorIdBasedOnSmartCity = [0];
            this.post_data.filter.by_anchor_id = this.anchorIdBasedOnSmartCity;
            if (lodash__WEBPACK_IMPORTED_MODULE_6__["isEmpty"](this.smartCityIds)) delete this.post_data.filter.by_anchor_id;
            this.post_data.pg.skip = 0;
      ...
      filterSector(event) {
        ...
        if (lodash__WEBPACK_IMPORTED_MODULE_6__["isEmpty"](this.challengeSector)) delete this.post_data.filter.sector;
        this.post_data.pg.skip = 0;
        this.getChallenges();
      }
      ...
      openRouteInNewTab(path) {
        const url = this.router.serializeUrl(this.router.createUrlTree(["/challenge/".concat(path)]));
    ...
    DiscoverChallengeProviderComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: "app-discover-challenge-provider",
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./discover-challenge-provider.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/discover/discover-challenge-provider/discover-challenge-provider.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./discover-challenge-provider.component.css */
      "./src/app/discover/discover-challenge-provider/discover-challenge-provider.component.css")).default]
  ...
  /***/
  function srcAppDiscoverDiscoverChallengeProviderDiscoverChallengesServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DiscoverChallengesService", function () {
      return DiscoverChallengesService;
    });
    /* harmony import */
    ...
    DiscoverChallengesService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: "root"
  ...
  /***/
  function srcAppDiscoverDiscoverOfferingsDiscoverOfferingsComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDiscoverDiscoverOfferingsDiscoverOfferingsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DiscoverOfferingsComponent", function () {
      return DiscoverOfferingsComponent;
    });
    /* harmony import */
    ...
    var _discover_solutions_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./discover-solutions.service */
    "./src/app/discover/discover-offerings/discover-solutions.service.ts");
    /* harmony import */


    var _const__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../../const */
    "./src/app/const.ts");
    /* harmony import */
    ...
    let DiscoverOfferingsComponent = class DiscoverOfferingsComponent {
      ...
      filterSector(event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          ...
          if (lodash__WEBPACK_IMPORTED_MODULE_6__["isEmpty"](this.challengeSector)) delete this.query.filter.sector;
      ...
      filterSolutionStage(event) {
        ...
        if (lodash__WEBPACK_IMPORTED_MODULE_6__["isEmpty"](this.solutionMaturity)) delete this.query.filter.stage;
        this.query.pg.skip = 0;
        this.listSolutions();
      }
      ...
      filterLocation(event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          ...
          if (lodash__WEBPACK_IMPORTED_MODULE_6__["isEmpty"](this.LocationIds)) delete this.query.filter.location;
          this.query.pg.skip = 0;
          this.listSolutions();
        });
      }
      ...
      filterTeamSize(event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          ...
          if (event.target.checked) {
            this.teamSizeFilterClauses.push({
              from: parseInt(from),
              to: parseInt(to)
            });
          } else {
          ...
          if (lodash__WEBPACK_IMPORTED_MODULE_6__["isEmpty"](this.teamSizeFilterClauses)) delete this.query.filter.teamsize;
          this.query.pg.skip = 0;
          this.listSolutions();
        });
      }
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_ngxs_store__WEBPACK_IMPORTED_MODULE_7__["Select"])(_state_loggedinuser_state__WEBPACK_IMPORTED_MODULE_8__["LoggedInUserState"])], DiscoverOfferingsComponent.prototype, "loggedInUser$", void 0);
    DiscoverOfferingsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: "app-discover-offerings",
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./discover-offerings.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/discover/discover-offerings/discover-offerings.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./discover-offerings.component.css */
      "./src/app/discover/discover-offerings/discover-offerings.component.css")).default]
  ...
  /***/
  function srcAppDiscoverDiscoverOfferingsDiscoverSolutionsServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DiscoverSolutionsService", function () {
      return DiscoverSolutionsService;
    });
    /* harmony import */
    ...
    let DiscoverSolutionsService = class DiscoverSolutionsService {
      ...
      getSolutionIdBasedOnChallengeSector(sectorIds) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          let response = yield this.http.post(this.api_url + "/solutions_challenge_sectors/select_mul", {
            filter: {
    ...
    DiscoverSolutionsService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: "root"
  ...
  /***/
  function srcAppDiscoverDiscoverProvidersDiscoverProvidersComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDiscoverDiscoverProvidersDiscoverProvidersComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DiscoverProvidersComponent", function () {
      return DiscoverProvidersComponent;
    });
    /* harmony import */
    ...
    var _discover_providers_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./discover-providers.service */
    ...
    let DiscoverProvidersComponent = class DiscoverProvidersComponent {
      ...
      filterEntity(event) {
        ...
        if (lodash__WEBPACK_IMPORTED_MODULE_6__["isEmpty"](this.entityType)) delete this.query.filter.role;
        this.query.pg.skip = 0;
        this.listProviders();
      }
      ...
      intersectArray(x, y) {
        if (lodash__WEBPACK_IMPORTED_MODULE_6__["isEmpty"](x)) return y;else if (lodash__WEBPACK_IMPORTED_MODULE_6__["isEmpty"](y)) return x;else return lodash__WEBPACK_IMPORTED_MODULE_6__["intersection"](x, y);
      }
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_ngxs_store__WEBPACK_IMPORTED_MODULE_7__["Select"])(_state_loggedinuser_state__WEBPACK_IMPORTED_MODULE_8__["LoggedInUserState"])], DiscoverProvidersComponent.prototype, "loggedInUser$", void 0);
    DiscoverProvidersComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: "app-discover-providers",
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./discover-providers.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/discover/discover-providers/discover-providers.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./discover-providers.component.css */
      "./src/app/discover/discover-providers/discover-providers.component.css")).default]
  ...
  /***/
  function srcAppDiscoverDiscoverProvidersDiscoverProvidersServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DiscoverProvidersService", function () {
      return DiscoverProvidersService;
    });
    /* harmony import */
    ...
    DiscoverProvidersService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: "root"
  ...
  /***/
  function srcAppDiscoverDiscoverRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DiscoverRoutingModule", function () {
    ...
    var _discover_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./discover.component */
    "./src/app/discover/discover.component.ts");
    /* harmony import */


    var _discover_offerings_discover_offerings_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./discover-offerings/discover-offerings.component */
    "./src/app/discover/discover-offerings/discover-offerings.component.ts");
    /* harmony import */


    var _discover_providers_discover_providers_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./discover-providers/discover-providers.component */
    "./src/app/discover/discover-providers/discover-providers.component.ts");
    /* harmony import */


    var _discover_challenge_provider_discover_challenge_provider_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./discover-challenge-provider/discover-challenge-provider.component */
    "./src/app/discover/discover-challenge-provider/discover-challenge-provider.component.ts");
    /* harmony import */


    var _select_sector_select_sector_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./select-sector/select-sector.component */
    ...
    DiscoverRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppDiscoverDiscoverModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DiscoverModule", function () {
    ...
    var _discover_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./discover-routing.module */
    "./src/app/discover/discover-routing.module.ts");
    /* harmony import */


    var _discover_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./discover.component */
    "./src/app/discover/discover.component.ts");
    /* harmony import */


    var _discover_offerings_discover_offerings_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./discover-offerings/discover-offerings.component */
    "./src/app/discover/discover-offerings/discover-offerings.component.ts");
    /* harmony import */


    var _discover_providers_discover_providers_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./discover-providers/discover-providers.component */
    "./src/app/discover/discover-providers/discover-providers.component.ts");
    /* harmony import */


    var _discover_challenge_provider_discover_challenge_provider_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./discover-challenge-provider/discover-challenge-provider.component */
    "./src/app/discover/discover-challenge-provider/discover-challenge-provider.component.ts");
    /* harmony import */
    ...
    var _widgets_sector_filter_sector_filter_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./widgets/sector-filter/sector-filter.component */
    "./src/app/discover/widgets/sector-filter/sector-filter.component.ts");
    /* harmony import */


    var _shared_widgets_widgets_module__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ../shared/widgets/widgets.module */
    "./src/app/shared/widgets/widgets.module.ts");
    /* harmony import */


    var _create_challenge_btn_modal_create_challenge_btn_modal_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./create-challenge-btn-modal/create-challenge-btn-modal.component */
    "./src/app/discover/create-challenge-btn-modal/create-challenge-btn-modal.component.ts");
    /* harmony import */


    var _select_sector_select_sector_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./select-sector/select-sector.component */
    "./src/app/discover/select-sector/select-sector.component.ts");
    /* harmony import */


    var angular_responsive_carousel__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    ...
    DiscoverModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_discover_component__WEBPACK_IMPORTED_MODULE_5__["DiscoverComponent"], _discover_offerings_discover_offerings_component__WEBPACK_IMPORTED_MODULE_6__["DiscoverOfferingsComponent"], _discover_providers_discover_providers_component__WEBPACK_IMPORTED_MODULE_7__["DiscoverProvidersComponent"], _discover_challenge_provider_discover_challenge_provider_component__WEBPACK_IMPORTED_MODULE_8__["DiscoverChallengeProviderComponent"], _widgets_sector_filter_sector_filter_component__WEBPACK_IMPORTED_MODULE_10__["SectorFilterComponent"], _create_challenge_btn_modal_create_challenge_btn_modal_component__WEBPACK_IMPORTED_MODULE_12__["CreateChallengeBtnModalComponent"], _select_sector_select_sector_component__WEBPACK_IMPORTED_MODULE_13__["SelectSectorComponent"], _select_sector_select_sector_component__WEBPACK_IMPORTED_MODULE_13__["SafeHtmlPipe"]],
      ...
      exports: [_create_challenge_btn_modal_create_challenge_btn_modal_component__WEBPACK_IMPORTED_MODULE_12__["CreateChallengeBtnModalComponent"]]
    })], DiscoverModule);
    /***/
  },
  ...
  /***/
  function srcAppDiscoverSelectSectorSelectSectorComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDiscoverSelectSectorSelectSectorComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SelectSectorComponent", function () {
      return SelectSectorComponent;
    });
    /* harmony export (binding) */
    ...
    var _select_sector_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./select-sector.service */
      ...
      getSelectedSector() {
        ...
        if (this.logged_in_user.userType == "seeker") {
          ...
          this._ss.getSelectedSectorAPI("provider", post_data).subscribe(response => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.choosen_sectors = response.data;
            this.followingSectorArr = this.choosen_sectors.map(sector => sector.frg_challenge_sector_id);
            this.sectorsInOnGoingSolutions = yield this._ss.getSectorIdsFollowedByProviderUnderSolutions(this.logged_in_user.userTypeId); // console.log(this.sectorsInOnGoingSolutions);
          ...
          if (this.sel_challengeSector.length == temp_arr.length) {
            if (this.logged_in_user.userType == "provider") {
              this._ss.saveSelectedSectorAPI("provider", temp_arr).subscribe(resp => {
                if (resp.status == true) {
                  this.router.navigate(["/provider/user/".concat(this.logged_in_user.slug)]);
                }
              });
            } else {
              this._ss.saveSelectedSectorAPI("seeker", temp_arr).subscribe(resp => {
                if (resp.status == true) {
                  this.router.navigate(["/seeker/user/".concat(this.logged_in_user.slug)]);
                }
              });
            }
          }
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_ngxs_store__WEBPACK_IMPORTED_MODULE_6__["Select"])(_state_loggedinuser_state__WEBPACK_IMPORTED_MODULE_7__["LoggedInUserState"])], SelectSectorComponent.prototype, "loggedInUser$", void 0);
    SelectSectorComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: "app-select-sector",
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./select-sector.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/discover/select-sector/select-sector.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./select-sector.component.css */
      "./src/app/discover/select-sector/select-sector.component.css")).default]
  ...
  /***/
  function srcAppDiscoverWidgetsSectorFilterFilterServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDiscoverWidgetsSectorFilterSectorFilterComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDiscoverWidgetsSectorFilterSectorFilterComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SectorFilterComponent", function () {
      return SectorFilterComponent;
    });
    /* harmony import */
    ...
    /*! ./filter.service */
    "./src/app/discover/widgets/sector-filter/filter.service.ts"); // import Swiper core and required modules


    let SectorFilterComponent = class SectorFilterComponent {
      constructor(_filter) {
        this._filter = _filter;
        this.onFilterChange = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"](); // OwlCarousel Options
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()], SectorFilterComponent.prototype, "onFilterChange", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], SectorFilterComponent.prototype, "sectors", void 0);
    SectorFilterComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: "app-sector-filter",
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./sector-filter.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/discover/widgets/sector-filter/sector-filter.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./sector-filter.component.css */
      "./src/app/discover/widgets/sector-filter/sector-filter.component.css")).default]
    })], SectorFilterComponent);
    /***/
  }
}]);
//# sourceMappingURL=default~challenge-challenge-module~cities-cities-module~discover-discover-module-es5.js.map